...
* [django-oauth-toolkit](https://github.com/jazzband/django-oauth-toolkit) ⭐ 3,336 | 🐛 49 | 🌐 Python | 📅 2026-09-02: Django OAuth Toolkit can help you providing out of the box all the endpoints, data and logic needed to add OAuth2 capabilities to your Django projects. Django OAuth Toolkit makes extensive use of the excellent OAuthLib, so that everything is rfc-compliant.
