...
* [django-rest-framework-simplejwt](https://github.com/davesque/django-rest-framework-simplejwt) ⭐ 4,332 | 🐛 160 | 🌐 Python | 📅 2026-09-14: A JSON Web Token authentication plugin for the Django REST Framework
...
* [drf-spectacular](https://github.com/tfranzel/drf-spectacular) ⭐ 2,860 | 🐛 212 | 🌐 Python | 📅 2026-09-02: Sane and flexible OpenAPI 3.0 schema generation for Django REST framework
...
* [drf-renderer-xlsx](https://github.com/wharton/drf-renderer-xlsx) ⭐ 244 | 🐛 9 | 🌐 Python | 📅 2026-09-08: Allows you to create XLSX for Django REST Framework
...
* [drf-excel](https://github.com/wharton/drf-excel) ⭐ 244 | 🐛 9 | 🌐 Python | 📅 2026-09-08: An XLSX spreadsheet renderer for Django REST Framework.
