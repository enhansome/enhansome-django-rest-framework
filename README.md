...
* [django-oauth-toolkit](https://github.com/jazzband/django-oauth-toolkit) ⭐ 3,335 | 🐛 44 | 🌐 Python | 📅 2026-09-02: Django OAuth Toolkit can help you providing out of the box all the endpoints, data and logic needed to add OAuth2 capabilities to your Django projects. Django OAuth Toolkit makes extensive use of the excellent OAuthLib, so that everything is rfc-compliant.
...
* [drf-yasg](https://github.com/axnsan12/drf-yasg) ⭐ 3,545 | 🐛 244 | 🌐 Python | 📅 2026-08-31: Alternative OpenAPI Generator for Django REST Framework with response schema support
* [drf-spectacular](https://github.com/tfranzel/drf-spectacular) ⭐ 2,860 | 🐛 207 | 🌐 Python | 📅 2026-09-02: Sane and flexible OpenAPI 3.0 schema generation for Django REST framework
...
* [drf-renderer-xlsx](https://github.com/wharton/drf-renderer-xlsx) ⭐ 240 | 🐛 11 | 🌐 Python | 📅 2026-09-01: Allows you to create XLSX for Django REST Framework
...
* [drf-excel](https://github.com/wharton/drf-excel) ⭐ 240 | 🐛 11 | 🌐 Python | 📅 2026-09-01: An XLSX spreadsheet renderer for Django REST Framework.
