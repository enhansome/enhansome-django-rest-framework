...
* [django-rest-framework-simplejwt](https://github.com/davesque/django-rest-framework-simplejwt) ⭐ 4,333 | 🐛 160 | 🌐 Python | 📅 2026-08-31: A JSON Web Token authentication plugin for the Django REST Framework
* [django-oauth-toolkit](https://github.com/jazzband/django-oauth-toolkit) ⭐ 3,335 | 🐛 43 | 🌐 Python | 📅 2026-09-01: Django OAuth Toolkit can help you providing out of the box all the endpoints, data and logic needed to add OAuth2 capabilities to your Django projects. Django OAuth Toolkit makes extensive use of the excellent OAuthLib, so that everything is rfc-compliant.
* [djoser](https://github.com/sunscrapers/djoser) ⭐ 2,680 | 🐛 201 | 🌐 Python | 📅 2026-08-01: REST implementation of Django authentication system
...
* [django-rest-passwordreset](https://github.com/anx-ckreuzberger/django-rest-passwordreset) ⭐ 436 | 🐛 29 | 🌐 Python | 📅 2026-06-30: Password reset endpoints that hook into Django Authentication system
...
* [drf-yasg](https://github.com/axnsan12/drf-yasg) ⭐ 3,545 | 🐛 242 | 🌐 Python | 📅 2026-08-31: Alternative OpenAPI Generator for Django REST Framework with response schema support
* [drf-spectacular](https://github.com/tfranzel/drf-spectacular) ⭐ 2,859 | 🐛 204 | 🌐 Python | 📅 2026-08-21: Sane and flexible OpenAPI 3.0 schema generation for Django REST framework
...
* [django-rest-framework-gis](https://github.com/djangonauts/django-rest-framework-gis) ⭐ 1,127 | 🐛 30 | 🌐 Python | 📅 2026-09-01: Geographic add-ons for Django REST Framework
* [drf-renderer-xlsx](https://github.com/wharton/drf-renderer-xlsx) ⭐ 240 | 🐛 10 | 🌐 Python | 📅 2026-09-01: Allows you to create XLSX for Django REST Framework
...
* [drf-excel](https://github.com/wharton/drf-excel) ⭐ 240 | 🐛 10 | 🌐 Python | 📅 2026-09-01: An XLSX spreadsheet renderer for Django REST Framework.
...
* [django-rest-framework-json-api](https://github.com/django-json-api/django-rest-framework-json-api) ⭐ 1,252 | 🐛 16 | 🌐 Python | 📅 2026-09-01: Implements most of the JSON API 1.0 spec.
