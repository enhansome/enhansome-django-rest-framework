...
* [django-rest-framework-simplejwt](https://github.com/davesque/django-rest-framework-simplejwt) ⭐ 4,330 | 🐛 160 | 🌐 Python | 📅 2026-09-14: A JSON Web Token authentication plugin for the Django REST Framework
* [django-oauth-toolkit](https://github.com/jazzband/django-oauth-toolkit) ⭐ 3,336 | 🐛 48 | 🌐 Python | 📅 2026-09-02: Django OAuth Toolkit can help you providing out of the box all the endpoints, data and logic needed to add OAuth2 capabilities to your Django projects. Django OAuth Toolkit makes extensive use of the excellent OAuthLib, so that everything is rfc-compliant.
...
* [drf-access-policy](https://github.com/rsinger86/drf-access-policy) ⭐ 512 | 🐛 28 | 🌐 Python | 📅 2024-08-20: Declarative access policies/permissions modeled after AWS' IAM policies.
* [dry-rest-permissions](https://github.com/dbkaplan/dry-rest-permissions) ⭐ 367 | 🐛 23 | 🌐 Python | 📅 2022-12-26: Rules based permissions.
...
* [drf-psq](https://github.com/drf-psq/drf-psq) ⭐ 49 | 🐛 1 | 🌐 Python | 📅 2021-02-26: The simplest and most general way to manage action-based permissions, serializers, and querysets dependent on permission-based rules.
...
* [drf-spectacular](https://github.com/tfranzel/drf-spectacular) ⭐ 2,860 | 🐛 214 | 🌐 Python | 📅 2026-09-02: Sane and flexible OpenAPI 3.0 schema generation for Django REST framework
...
* [drf-writable-nested](https://github.com/beda-software/drf-writable-nested) ⭐ 1,138 | 🐛 71 | 🌐 Python | 📅 2026-09-10: Writable nested model serializer for Django REST Framework
...
* [django-rest-framework-gis](https://github.com/djangonauts/django-rest-framework-gis) ⭐ 1,125 | 🐛 29 | 🌐 Python | 📅 2026-09-09: Geographic add-ons for Django REST Framework
...
* [django-orm-lens](https://github.com/FROWNINGdev/django-orm-lens) ⭐ 74 | 🐛 6 | 🌐 Python | 📅 2026-09-14: Static analyzer for Django models — sidebar tree, ER diagram, ORM linter, MCP server. Helps trace model shapes that ViewSets and Serializers reason about. No DB, no Django boot.
