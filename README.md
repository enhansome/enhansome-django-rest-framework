...
* [drf-spectacular](https://github.com/tfranzel/drf-spectacular) ⭐ 2,862 | 🐛 212 | 🌐 Python | 📅 2026-09-02: Sane and flexible OpenAPI 3.0 schema generation for Django REST framework
...
* [django-rest-framework-gis](https://github.com/djangonauts/django-rest-framework-gis) ⭐ 1,126 | 🐛 29 | 🌐 Python | 📅 2026-09-08: Geographic add-ons for Django REST Framework
* [drf-renderer-xlsx](https://github.com/wharton/drf-renderer-xlsx) ⭐ 242 | 🐛 9 | 🌐 Python | 📅 2026-09-08: Allows you to create XLSX for Django REST Framework
...
* [drf-excel](https://github.com/wharton/drf-excel) ⭐ 242 | 🐛 9 | 🌐 Python | 📅 2026-09-08: An XLSX spreadsheet renderer for Django REST Framework.
