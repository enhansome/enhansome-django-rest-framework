...
* [django-rest-framework-simplejwt](https://github.com/davesque/django-rest-framework-simplejwt) ⭐ 4,331 | 🐛 160 | 🌐 Python | 📅 2026-09-14: A JSON Web Token authentication plugin for the Django REST Framework
* [django-oauth-toolkit](https://github.com/jazzband/django-oauth-toolkit) ⭐ 3,336 | 🐛 46 | 🌐 Python | 📅 2026-09-02: Django OAuth Toolkit can help you providing out of the box all the endpoints, data and logic needed to add OAuth2 capabilities to your Django projects. Django OAuth Toolkit makes extensive use of the excellent OAuthLib, so that everything is rfc-compliant.
...
* [drf-yasg](https://github.com/axnsan12/drf-yasg) ⭐ 3,544 | 🐛 242 | 🌐 Python | 📅 2026-09-07: Alternative OpenAPI Generator for Django REST Framework with response schema support
* [drf-spectacular](https://github.com/tfranzel/drf-spectacular) ⭐ 2,859 | 🐛 214 | 🌐 Python | 📅 2026-09-02: Sane and flexible OpenAPI 3.0 schema generation for Django REST framework
